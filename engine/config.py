dict={
  ...
  "en": {
    ...
    "ru": {
        ...
        "intro_1": "Загрузи свою запись или выбери одну из тестовых мп3. Модель обучена распознавать чуть более 350 видов птиц Европы и Сев. Америки",
        "lang": "Язык",
        "Geo": "Локализация",
        ...
        "inference_expl": "Черно-белые мелспектрограммы демонстрируют, как машина <<видит>> звук: на каждые 5 секунд трека алгоритм возвращает вероятность присутствия каждой из 350+ птиц - показаны непрерывными цветными линиями. Используйте UI элементы Plotly чтобы приблизить или выделить.",
    ...
    "uk": {
        ...
        "intro_1": "Завантажуй свій запис або вибери один з тестових мп3. Модель розпізнає більше 350 найрозповсюдженіших птахів Європи та Північної Америки",
        "lang": "Мова",
        "Geo": "Локація",
        ...
        "inference_expl": "Чорно-білі мелспектрограми демонструють, як машина <<бачить>> звук: на кожні 5 секунд треку алгоритм обчислює ймовірність присутності кожного з 350+ птахів - показані кольоровими лініями. Використовуй UI елементи Plotly для того, щоб приблизити або виділити на графіку.",
  ...
  "de": {
   ...
   "fr": {
    ...
    "pl": {
        ...
        "uploaded_msg": "Ground Truth of uploaded files unknown",
        "inference_expl": "The audio you'd just uploaded was transformed into mel-spectrograms (black-and-white). The machine goes by 5-second frames and returns probabilities of each of 350+ species shown as continuous lines on a colored plot. Use Plotly UI elements to manipulate the plot.",
        "low_certainty_msg": "* - predictions with certainty <5 % considered unreliable",
        "select_mp3": "Select mp3 from validation batch",
        "upload_mp3": "Upload pre-recorded mp3",
          "top_guess": "Top guess: ",
